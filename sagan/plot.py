...
def plot_fit(wave, flux, model, weight=None, error=None, ax=None, axr=None, xlim=None, ylim0=None, 
             ylim1=None, xlabel=None, ylabel=None, legend_kwargs=None, norm_res=False):
    '''
    ...
    flux_res_norm=flux_res/error
    if norm_res:
        axr.step(wave, flux_res_norm, lw=1, color='k', where='mid')
    else:
